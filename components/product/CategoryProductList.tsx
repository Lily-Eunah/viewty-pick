...
export default function CategoryProductList({ initialProducts }: Props) {
  ...
  const products = useMemo(() => {
    ...
    const copy = [...result];
    if (sortBy === 'recommend') copy.sort((a, b) => b.viewtyScore - a.viewtyScore);
    else if (sortBy === 'price_asc') copy.sort((a, b) => a.lowestPrice - b.lowestPrice);
    else if (sortBy === 'price_drop') copy.sort((a, b) => (b.priceDropAmount || 0) - (a.priceDropAmount || 0));
    return copy;
