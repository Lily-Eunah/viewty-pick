...
export default function BottomTabBar({ activeTab }: BottomTabBarProps) {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[430px] h-[72px] bg-surface border-t border-line flex items-center justify-around px-4 z-40 shadow-[0_-4px_10px_rgba(0,0,0,0.03)]">
      {/* 1. 홈 */}
      <Link
        href="/"
        className={`flex flex-col items-center justify-center gap-1 w-[60px] h-full ${
          activeTab === 'home' ? 'text-primary' : 'text-[#AAA697]'
        }`}
      >
      ...
      <Link
        href="/c/sunscreen"
        className={`flex flex-col items-center justify-center gap-1 w-[60px] h-full ${
          activeTab === 'category' ? 'text-primary' : 'text-[#AAA697]'
        }`}
      >
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.2} stroke="currentColor" className="w-6 h-6">
      ...
      <Link
        ...
        className={`flex flex-col items-center justify-center gap-1 w-[60px] h-full ${
          activeTab === 'search' ? 'text-primary' : 'text-[#AAA697]'
        } opacity-60`}
      >
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.2} stroke="currentColor" className="w-6 h-6">
      ...
      <Link
        ...
        className={`flex flex-col items-center justify-center gap-1 w-[60px] h-full ${
          activeTab === 'wishlist' ? 'text-primary' : 'text-[#AAA697]'
        } opacity-60`}
      >
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.2} stroke="currentColor" className="w-6 h-6">
      ...
      <Link
        ...
        className={`flex flex-col items-center justify-center gap-1 w-[60px] h-full ${
          activeTab === 'my' ? 'text-primary' : 'text-[#AAA697]'
        } opacity-60`}
      >
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.2} stroke="currentColor" className="w-6 h-6">
