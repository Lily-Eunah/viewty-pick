...
// oliveyoung: 올영 가격은 네이버 쇼핑 API에 뜨는 올영 오퍼로 수집 (올영 = 또 하나의
//   공식몰). allowed_store_name='올리브영'을 mallName 앵커로 사용 — 네이버 쇼핑에서
//   올영이 노출되는 정확 표기는 라이브 검증값(§4)이며, 다르면 이 값을 갱신한다.
const ALLOWLIST = [
  ...
  ['oliveyoung', '스타라이크', '올리브영', 'true'],
  ['oliveyoung', '아로셀',     '올리브영', 'true'],
  ['oliveyoung', '이니스프리', '올리브영', 'true'],
  ['oliveyoung', '조선미녀',   '올리브영', 'true'],
  ['oliveyoung', '넘버즈인',   '올리브영', 'true'],
];
