...
export const mockCategoriesRefSheet = [
  ...
  { 대분류: '스킨케어',       대분류_slug: 'skincare',       소분류: '디바이스',         소분류_slug: 'device',          sort_order: '6' },
  ...
  { 대분류: '클렌징',         대분류_slug: 'cleansing-care', 소분류: '립&아이 리무버',    소분류_slug: 'lip&eye makeup remover', sort_order: '4' },
  ...
  { 대분류: '바디케어',       대분류_slug: 'bodycare',       소분류: '쉐이빙폼/젤/크림',  소분류_slug: 'shaving',         sort_order: '3' },
  { 대분류: '바디케어',       대분류_slug: 'bodycare',       소분류: '태닝/애프터선',    소분류_slug: 'tanning/after-sun', sort_order: '3' },
  { 대분류: '베이스 메이크업', 대분류_slug: 'base-makeup',    소분류: '쿠션',            소분류_slug: 'cushion',         sort_order: '1' },
  { 대분류: '베이스 메이크업', 대분류_slug: 'base-makeup',    소분류: '파운데이션',       소분류_slug: 'foundation',      sort_order: '2' },
  { 대분류: '베이스 메이크업', 대분류_slug: 'base-makeup',    소분류: 'BB/CC',          소분류_slug: 'BB/CC',           sort_order: '3' },
  { 대분류: '베이스 메이크업', 대분류_slug: 'base-makeup',    소분류: '컨실러',          소분류_slug: 'Concealer',       sort_order: '4' },
  { 대분류: '헤어케어',       대분류_slug: 'haircare',       소분류: '샴푸/스케일러',    소분류_slug: 'shampoo/scaler',   sort_order: '1' },
  { 대분류: '헤어케어',       대분류_slug: 'haircare',       소분류: '두피에센스',       소분류_slug: 'scalp tonic',     sort_order: '2' },
  { 대분류: '위생용품',       대분류_slug: 'Feminine Hygiene', 소분류: 'Y존케어',          소분류_slug: 'Intimate Care',   sort_order: '1' },
];
