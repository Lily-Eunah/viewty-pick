    ...
    try {
      ...
      for (const row of rawProducts) {
        ...
        const { error } = await supabaseServer.from('products').upsert({
          ...
          features_detail: p.data.features_detail || null,
