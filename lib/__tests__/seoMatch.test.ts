...
const catalog: UIProduct[] = [
  prod({ id: '1', name: '진정 시카 토너', category: 'toner', majorCategory: 'skincare', skinTypes: ['민감성', '건성'], features: ['진정'] }),
  prod({ id: '2', name: '약산성 토너', category: 'toner', majorCategory: 'skincare', skinTypes: ['지성'], features: ['약산성'] }),
  prod({ id: '3', name: '보습 크림', category: 'cream', majorCategory: 'skincare', skinTypes: ['건성'], features: ['보습'] }),
  prod({ id: '4', name: '포 맨 올인원', category: 'allinone', majorCategory: 'skincare', skinTypes: ['복합성'], brand: '이니스프리' }),
  prod({ id: '5', name: '톤업 선크림', category: 'sunscreen', majorCategory: 'suncare', skinTypes: ['건성'], features: ['톤업'] }),
];
